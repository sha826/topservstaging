...
- [x] ~~Pricing source of truth~~ SUPERSEDED by Build Spec v2 (late Aug 2026): the tier table is retired entirely. The only public numbers are the $1,000/week floor and the $10,000 one-time activation; never monthly, never annual, no tier names with prices. Implemented site-wide (pricing page, FAQs, service/industry copy, blog, llms.txt, pricing.md, chat agent). See `docs/HANDOFF.md`.
