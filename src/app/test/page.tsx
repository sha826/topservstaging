...
import { BeforeAfterTable } from "@/components/test/before-after-table";
import { DependencyProblem } from "@/components/test/dependency-problem";
import { FiveMileFamous } from "@/components/test/five-mile-famous";

/**
 * New home page, in progress, served at /test.
 *
 ...
 *
 * Deliberately NOT indexed. SEO Guidelines section 2.8 requires preview
 * routes to be noindex, and section 3.2 forbids 2 pages competing for 1
 * primary keyword: the production home page owns "topserv digital". This
 * route is also kept out of sitemap.ts for the same reason.
 *
 * Organization schema is intentionally absent. ProfessionalServiceJsonLd
 * declares @id "/#organization" and is emitted once, on the production home
 * page. Emitting it here too would put 2 conflicting entity blocks on 1 id.
 */
    ...
    <>
        ...
        <div className="mx-auto max-w-6xl px-5 py-16 md:py-24">
          <Reveal>
            ...
            <p className="mt-5 max-w-2xl text-lg leading-relaxed text-muted-foreground">
              ...
              agency. We created a category, and it exists because home service
              companies were being told to choose between building a brand and
              generating leads. That is the wrong decision. Run as 1 system,
              each side makes the other cheaper.
            </p>
          </Reveal>
          ...
          <Reveal className="mt-10 grid gap-4 md:grid-cols-3">
            <p className="text-base leading-relaxed text-muted-foreground">
              ...
              Familiarity, trust and preference built before anything breaks,
              so you are already the answer when it does.
            </p>
            <p className="text-base leading-relaxed text-muted-foreground">
              <strong className="font-semibold text-foreground">
                Performance captures demand.
              </strong>{" "}
              Search, maps and Local Services put you in front of the customer
              at the exact moment they are ready to buy.
            </p>
            <p className="text-base leading-relaxed text-muted-foreground">
              <strong className="font-semibold text-foreground">
                BrandFormance builds market dominance.
              </strong>{" "}
              Together they compound. Brand investment is judged by what it
              does to performance efficiency, on 1 measurement system.
            </p>
          </Reveal>
      ...
      <section aria-labelledby="transformation-heading" className="border-b border-border">
        <div className="mx-auto max-w-6xl px-5 py-16 md:py-24">
          ...
          <div className="mt-14">
            <Reveal>
              <h3 className="display text-2xl md:text-3xl">What actually changes</h3>
            </Reveal>
