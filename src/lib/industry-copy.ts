    ...
    faqs: [
      {
        ...
        answer:
          "A common benchmark for growth-mode home service companies is 5–10% of annual revenue. A $3M HVAC company investing at that level is spending $150K–$300K a year — TopServ's BRAND Accelerator plan at $2,000/week ($104K/year) sits inside that range with video production included.",
      },
      {
